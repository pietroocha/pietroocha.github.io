	 ...
	 <div class="container">
	   ...
	   <div class="content">
	     <div class="main">';
	       ...
	       $wynik = mysql_query("SELECT p.dataPrzelewu, p.tytulPrzelewu, k.imie, k.nazwisko, p.kwotaPrzelewu, p.saldoOdbPoOperacji FROM przelew as p inner join klient as k on p.id_klient_nad = k.id_klient where p.id_klient_odb = '$idKlient'")
	       or die('Błąd zapytania');

           $wynik2 = mysql_query("SELECT p.dataPrzelewu, p.tytulPrzelewu, k.imie, k.nazwisko, p.kwotaPrzelewu, p.saldoNadPoOperacji FROM przelew as p inner join klient as k on p.id_klient_odb = k.id_klient where p.id_klient_nad = '$idKlient'")
           or die('Błąd zapytania');
